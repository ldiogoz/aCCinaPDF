...
public final class SignatureHandler extends MouseAdapter {
     ...
     */
    public SignatureHandler(Component... components) {
     ...
     * @param components components to be automatically registered
     */
    public SignatureHandler(Insets dragInsets, Component... components) {
     ...
     * @param components components to be automatically registered
     */
    public SignatureHandler(Insets dragInsets, Dimension snapSize, Component... components) {
